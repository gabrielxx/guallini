...
-- Volcando estructura de base de datos para gk12_guallini
CREATE DATABASE IF NOT EXISTS `gk12_guallini` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gk12_guallini`;

-- Volcando estructura para tabla gk12_guallini.aire_acondicionado
CREATE TABLE IF NOT EXISTS `aire_acondicionado` (
  `id_aireacondicionado` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_aireacondicionado`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.aire_acondicionado: 2 rows
/*!40000 ALTER TABLE `aire_acondicionado` DISABLE KEYS */;
INSERT INTO `aire_acondicionado` (`id_aireacondicionado`, `nombre`) VALUES
	(1, '1 split.'),
	(2, 'Split.');
/*!40000 ALTER TABLE `aire_acondicionado` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.artefacto_cocina
CREATE TABLE IF NOT EXISTS `artefacto_cocina` (
  `id_artefacto_cocina` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_artefacto_cocina`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.artefacto_cocina: 0 rows
/*!40000 ALTER TABLE `artefacto_cocina` DISABLE KEYS */;
/*!40000 ALTER TABLE `artefacto_cocina` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.barrio
...
-- Volcando datos para la tabla gk12_guallini.barrio: 178 rows
...
-- Volcando estructura para tabla gk12_guallini.ciudad
...
-- Volcando datos para la tabla gk12_guallini.ciudad: 8 rows
...
-- Volcando estructura para tabla gk12_guallini.cochera
CREATE TABLE IF NOT EXISTS `cochera` (
  `id_cocheras` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_cocheras`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.cochera: 5 rows
...
-- Volcando estructura para tabla gk12_guallini.estado
...
-- Volcando datos para la tabla gk12_guallini.estado: 5 rows
...
-- Volcando estructura para tabla gk12_guallini.faq
...
-- Volcando datos para la tabla gk12_guallini.faq: 28 rows
...
-- Volcando estructura para tabla gk12_guallini.imagenes
...
-- Volcando datos para la tabla gk12_guallini.imagenes: 114 rows
...
INSERT INTO `imagenes` (`id_imagen`, `id_propiedad`, `id_tipo_imagen`, `titulo`, `nombre`, `descripcion`) VALUES
	...
	(722, 160, 3, NULL, '20130415_121029.jpg', NULL),
	(723, 160, 3, NULL, '20130415_121040.jpg', NULL),
	...
	(757, 177, 3, 'fachada', '20130815_133609_(2).jpg', NULL),
	(797, 193, 2, NULL, '20131214_105402.jpg', NULL),
	(798, 193, 2, NULL, '20131214_105526.jpg', NULL),
	(799, 193, 2, NULL, '20131214_105324.jpg', NULL),
	(800, 177, 1, NULL, '20140124_191952.jpg', NULL),
	(801, 177, NULL, NULL, '20130913_154739.jpg', NULL),
	(802, 177, NULL, NULL, '20130913_154853_(2).jpg', NULL),
	(803, 177, 1, NULL, '20130913_154739(1).jpg', NULL),
	(804, 177, 1, NULL, '20130913_154747.jpg', NULL),
	...
	(994, NULL, 3, NULL, NULL, NULL);
/*!40000 ALTER TABLE `imagenes` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.latitud
CREATE TABLE IF NOT EXISTS `latitud` (
  `id_latitud` int(11) NOT NULL AUTO_INCREMENT,
  `id_propiedad` int(11) NOT NULL,
  `latitud` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_latitud`,`id_propiedad`),
  UNIQUE KEY `id_latitud` (`id_latitud`)
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.latitud: 47 rows
/*!40000 ALTER TABLE `latitud` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `latitud` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.localidad
...
-- Volcando datos para la tabla gk12_guallini.localidad: 44 rows
...
-- Volcando estructura para tabla gk12_guallini.moneda
...
-- Volcando datos para la tabla gk12_guallini.moneda: 2 rows
...
-- Volcando estructura para tabla gk12_guallini.mueble_cocina
CREATE TABLE IF NOT EXISTS `mueble_cocina` (
  `id_muebles_cocina` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_muebles_cocina`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.mueble_cocina: 2 rows
/*!40000 ALTER TABLE `mueble_cocina` DISABLE KEYS */;
INSERT INTO `mueble_cocina` (`id_muebles_cocina`, `nombre`) VALUES
	(1, 'Sobre mesada y bajo mesada.'),
	(2, 'Sin.');
/*!40000 ALTER TABLE `mueble_cocina` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.orientacion
...
-- Volcando datos para la tabla gk12_guallini.orientacion: 11 rows
...
-- Volcando estructura para tabla gk12_guallini.partido
...
-- Volcando datos para la tabla gk12_guallini.partido: 10 rows
...
-- Volcando estructura para tabla gk12_guallini.propiedad
...
) ENGINE=MyISAM AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;

-- Volcando datos para la tabla gk12_guallini.propiedad: 49 rows
...
INSERT INTO `propiedad` (`id_propiedad`, `id_tipo_propiedad`, `id_tipo_operacion`, `id_tipo_moneda`, `id_provincia`, `id_partido`, `id_ciudad`, `id_localidad`, `id_barrio`, `id_orientacion`, `id_tipo_zona`, `precio`, `calle`, `nro`, `entre`, `cerca`, `plantas`, `estado`, `dormitorios`, `antiguedad`, `descripcion140`, `descripcion`, `sup_cubierta`, `sup_descubierta`, `sup_total`, `hab_servicio`, `ent_servicio`, `frente_medida`, `parrilla`, `quincho`, `piscina`, `ocupada`, `destacado`, `terraza`, `banio_servicio`, `comedor_diario`, `office`, `cocina`, `toilettes`, `banio`, `dormitorio`, `suite`, `playroom`, `comedor`, `living`, `escritorio`, `slider`, `home`, `publicar`) VALUES
	...
	(264, 1, 1, 2, 1, 1, 9, 1, 13, NULL, 3, 200000, 'Carlos Casares', 3315, NULL, 'Acceso Tigre', 2, 'Muy bueno', 4, 20, 'Casa ideal dos familias', 'xcelente casa ideal dos familias, buena ubicación a cuadras del Acceso Norte.\r\nPB: jardin, entrada para dos autos, living comedor, dos dormitorios con placard, baño completo, cocina, lavadero independiente, cuarto de herramientas.patio.\r\nPA: Living comedor, dos dormitorios con placard, baño completo, cocina, lavadero, patio pequeño.\r\n"DIGNA DE VER"', '145', NULL, '200', NULL, NULL, NULL, 1, NULL, 0, 1, 0, '1', NULL, '2', NULL, '2', NULL, '2', '4', NULL, NULL, '2', '2', NULL, NULL, 0, 1),
...
-- Volcando estructura para tabla gk12_guallini.propiedad_Ant
CREATE TABLE IF NOT EXISTS `propiedad_Ant` (
  `id_propiedad` int(11) NOT NULL AUTO_INCREMENT,
  `id_tipo_propiedad` int(11) DEFAULT NULL,
  `id_tipo_operacion` int(11) DEFAULT NULL,
  `id_tipo_moneda` int(20) DEFAULT NULL,
  ...
  `publicar` int(2) DEFAULT '0',
  PRIMARY KEY (`id_propiedad`)
) ENGINE=MyISAM AUTO_INCREMENT=225 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;

-- Volcando datos para la tabla gk12_guallini.propiedad_Ant: 72 rows
/*!40000 ALTER TABLE `propiedad_Ant` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `propiedad_Ant` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.provincia
...
-- Volcando datos para la tabla gk12_guallini.provincia: 2 rows
...
-- Volcando estructura para tabla gk12_guallini.revestimientos
CREATE TABLE IF NOT EXISTS `revestimientos` (
  `id_revestimiento` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_revestimiento`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.revestimientos: 2 rows
/*!40000 ALTER TABLE `revestimientos` DISABLE KEYS */;
INSERT INTO `revestimientos` (`id_revestimiento`, `nombre`) VALUES
	(1, 'Ladrillo a la vista'),
	(2, 'Tarquini');
/*!40000 ALTER TABLE `revestimientos` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.telefono
...
-- Volcando datos para la tabla gk12_guallini.telefono: 4 rows
...
-- Volcando estructura para tabla gk12_guallini.tipo_imagen
CREATE TABLE IF NOT EXISTS `tipo_imagen` (
  `id_tipo_imagen` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
...
-- Volcando datos para la tabla gk12_guallini.tipo_imagen: 4 rows
/*!40000 ALTER TABLE `tipo_imagen` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tipo_imagen` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.tipo_lavadero
CREATE TABLE IF NOT EXISTS `tipo_lavadero` (
  `id_lavadero` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_lavadero`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.tipo_lavadero: 3 rows
/*!40000 ALTER TABLE `tipo_lavadero` DISABLE KEYS */;
INSERT INTO `tipo_lavadero` (`id_lavadero`, `nombre`) VALUES
	(1, 'Xubierto'),
	(2, 'Integrado'),
	(3, 'En balcon Cubierto');
/*!40000 ALTER TABLE `tipo_lavadero` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.tipo_moneda
...
-- Volcando datos para la tabla gk12_guallini.tipo_moneda: 2 rows
...
-- Volcando estructura para tabla gk12_guallini.tipo_operacioon
CREATE TABLE IF NOT EXISTS `tipo_operacioon` (
  `id_tipo_operacion` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_tipo_operacion`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla gk12_guallini.tipo_operacioon: 10 rows
/*!40000 ALTER TABLE `tipo_operacioon` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tipo_operacioon` ENABLE KEYS */;

-- Volcando estructura para tabla gk12_guallini.tipo_propiedad
...
-- Volcando datos para la tabla gk12_guallini.tipo_propiedad: 25 rows
...
-- Volcando estructura para tabla gk12_guallini.zona
...
-- Volcando datos para la tabla gk12_guallini.zona: 3 rows
